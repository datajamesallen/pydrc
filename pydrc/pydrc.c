...
// COPY OF fit4pdrc but with fit2d
static PyObject* top_const_fit4pdrc(PyObject* self, PyObject* args) {
	// first test with a list of responses for a set doses list
	PyObject *doseList;
	PyObject *doseItem;
	PyObject *resList;
...
// COPY OF fit4pdrc but with fit3d
static PyObject* bot_const_fit4pdrc(PyObject* self, PyObject* args) {
	// first test with a list of responses for a set doses list
	PyObject *doseList;
	PyObject *doseItem;
	PyObject *resList;
...
// COPY OF fit4pdrc but with fit4d
static PyObject* both_const_fit4pdrc(PyObject* self, PyObject* args) {
	// first test with a list of responses for a set doses list
	PyObject *doseList;
	PyObject *doseItem;
	PyObject *resList;
...
static PyMethodDef myMethods[] = {
	...
	{"top_const_fit4pdrc",top_const_fit4pdrc, METH_VARARGS, "fits a dose response curve with the top constrained"},
	{"bot_const_fit4pdrc",bot_const_fit4pdrc, METH_VARARGS, "fits a dose response curve with the bot constrained"},
	{"both_const_fit4pdrc",both_const_fit4pdrc, METH_VARARGS, "fits a dose response curve with top and bot constrained"},
	{NULL,NULL,0,NULL}
};
